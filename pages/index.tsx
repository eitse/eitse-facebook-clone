...
const Home = ({ session, posts }: Props) => {
  ...
  // else
  return (
    <div className="scrollbar scrollbar-track-gray-300 scrollbar-track-rounded-lg scrollbar-thumb-[#f7ac0acb] hover:scrollbar-thumb-[#F7AB0A] scrollbar-thumb-rounded-lg">
      <Head>
